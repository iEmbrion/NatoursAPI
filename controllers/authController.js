...
exports.signup = catchAsync(async (req, res, next) => {
  //to prevent parameter pollution (e.g. role="admin")
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user)
    return next(
      new AppError('Email not found! Please provide a valid email.', 404)
    );
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  if (!user) next(new AppError('Token is invalid or Token has expired', 400));
